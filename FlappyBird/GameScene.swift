...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var itemNode: SKNode!
    let itemSound = SKAction.playSoundFileNamed("itemSound.wav", waitForCompletion: false)
    ...
    func setupItem() {
        ...
        let createItemAnimation = SKAction.run({
            ...
            let random_y = CGFloat.random(in: -20...20)
            
            let itemSprite = SKSpriteNode(texture: itemTexture)
            itemSprite.position = CGPoint(x: 0, y: Int(center_y + random_y))
